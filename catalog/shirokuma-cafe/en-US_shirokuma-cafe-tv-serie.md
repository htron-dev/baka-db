...
-   **type**: tv-serie
-   **episodes**: 50
-   **original-name**: しろくまカフェ
-   **start-date**: 2012-04-05
-   **end-date**: 2012-04-05
-   **opening-song**: #1: "Boku ni Invitation (ボクにインビテーション)" by JP (eps 1-26)
-   **ending-song**: #01: "Bamboo☆Scramble" by Jun Fukuyama (eps 1-5)
-   **rating**: G - All Ages
...
-   [My Anime list](https://myanimelist.net/anime/12815/Shirokuma_Cafe)
-   [Official Site](http://www.tv-tokyo.co.jp/anime/shirokumacafe/)
-   [AnimeDB](http://anidb.info/perl-bin/animedb.pl?show=anime&aid=8934)
-   [AnimeNewsNetwork](http://www.animenewsnetwork.com/encyclopedia/anime.php?id=13985)
-   [Wikipedia](http://en.wikipedia.org/wiki/Shirokuma_Café)
