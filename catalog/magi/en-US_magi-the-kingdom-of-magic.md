...
-   **end-date**: 2013-10-06
-   **opening-song**: #1: "ANNIVERSARY" by SID (eps 1-13)
-   **ending-song**: #1: "Eden (エデン)" by Aqua Timez (eps 1-13)
...
-   [My Anime list](https://myanimelist.net/anime/18115/Magi__The_Kingdom_of_Magic)
-   [Official Site](http://www.project-magi.com/)
-   [AnimeDB](http://anidb.info/perl-bin/animedb.pl?show=anime&aid=9807)
-   [AnimeNewsNetwork](http://www.animenewsnetwork.com/encyclopedia/anime.php?id=15543)
