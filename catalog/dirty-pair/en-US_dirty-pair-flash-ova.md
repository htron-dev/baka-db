...
-   **type**: ova
-   **episodes**: 6
-   **original-name**: ダーティペア FLASH
-   **start-date**: 1994-01-21
-   **end-date**: 1994-01-21
-   **opening-song**: #1: "Kagirinai Answer (限りない ANSWER)" by Mana (eps 1-6)
-   **ending-song**: #1: "Dai 2 Shou (第 2 章)" by Mana (eps 1-6)
...
-   [My Anime list](https://myanimelist.net/anime/1802/Dirty_Pair_Flash)
-   [Official Site](http://www.sunrise-inc.co.jp/work/detail.php?cid=107)
-   [AnimeDB](http://anidb.info/perl-bin/animedb.pl?show=anime&aid=402)
-   [AnimeNewsNetwork](http://www.animenewsnetwork.com/encyclopedia/anime.php?id=535)
