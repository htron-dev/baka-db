...
-   **type**: tv-serie
-   **episodes**: 12
-   **original-name**: ビビッドレッド・オペレーション
-   **start-date**: 2013-01-11
-   **end-date**: 2013-01-11
-   **opening-song**: "ENERGY" by earthmind (eps 2-11)
-   **ending-song**: #1: "ENERGY" by earthmind (ep 1)
...
-   [My Anime list](https://myanimelist.net/anime/14283/Vividred_Operation)
-   [Official Site](http://www.vividred.net/)
-   [AnimeDB](http://anidb.info/perl-bin/animedb.pl?show=anime&aid=9242)
-   [AnimeNewsNetwork](http://www.animenewsnetwork.com/encyclopedia/anime.php?id=14723)
-   [Wikipedia](http://en.wikipedia.org/wiki/Vividred_Operation)
