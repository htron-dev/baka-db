...
-   **end-date**: 2005-10-05
-   **opening-song**: #1: "FLY HIGH" by surface (eps 1-14)
-   **ending-song**: #1: "Kimi to Iu na no Hikari" by Cluster'S (eps 01-14, 25)
...
-   [My Anime list](https://myanimelist.net/anime/69/Cluster_Edge)
-   [Official Site](http://www.cluster-edge.net/)
-   [AnimeDB](http://anidb.info/perl-bin/animedb.pl?show=anime&aid=2392)
-   [AnimeNewsNetwork](http://www.animenewsnetwork.com/encyclopedia/anime.php?id=4671)
-   [Wikipedia](http://en.wikipedia.org/wiki/Cluster_Edge)
