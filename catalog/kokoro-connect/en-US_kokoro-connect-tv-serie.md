...
-   **type**: tv-serie
-   **episodes**: 13
-   **original-name**: ココロコネクト
-   **start-date**: 2012-07-08
-   **end-date**: 2012-07-08
-   **opening-song**: #1: "Paradigm (パラダイム)" by eufonius (eps 1-10)
-   **ending-song**: #1: "Kokoro no Kara (ココロノカラ)" by Team.Nekokan [Neko] featuring. Junca Amaoto (eps 1-5)
...
-   [My Anime list](https://myanimelist.net/anime/11887/Kokoro_Connect)
-   [Official Site](http://www.kokoro-connect.com/)
-   [AnimeDB](http://anidb.info/perl-bin/animedb.pl?show=anime&aid=8742)
-   [AnimeNewsNetwork](http://www.animenewsnetwork.com/encyclopedia/anime.php?id=14113)
-   [Wikipedia](http://en.wikipedia.org/wiki/Kokoro_Connect)
