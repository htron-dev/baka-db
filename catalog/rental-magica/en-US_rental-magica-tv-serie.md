...
-   **end-date**: 2007-10-08
-   **opening-song**: #1: "Sora ni Saku (宇宙(そら)に咲く)" by Lisa Komine (eps 2-5, 13-18, 22)
-   **ending-song**: #1: "Sora ni Saku (宇宙(そら)に咲く)" by Lisa Komine (ep 1)
...
-   [My Anime list](https://myanimelist.net/anime/2369/Rental_Magica)
-   [AnimeDB](http://anidb.info/perl-bin/animedb.pl?show=anime&aid=5189)
-   [AnimeNewsNetwork](http://www.animenewsnetwork.com/encyclopedia/anime.php?id=8033)
-   [Wikipedia](http://en.wikipedia.org/wiki/Rental_Magica)
